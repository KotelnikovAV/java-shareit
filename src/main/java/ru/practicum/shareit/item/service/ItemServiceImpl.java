...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto findById(long id) {
        ...
        itemDto.setLastBooking(bookingMapper
                .bookingToResponseBookingDto(bookingRepository.findByItemIdPast(id, LocalDateTime.now(), Status.REJECTED)));
        itemDto.setNextBooking(bookingMapper
                .bookingToResponseBookingDto(bookingRepository.findByItemIdFuture(id, LocalDateTime.now(), Status.REJECTED)));
